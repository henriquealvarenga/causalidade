...
1. Estatística sanitária do século XIX, sem teoria de mecanismo;
2. Era bacteriológica fundada nos postulados de Henle-Koch — causalidade determinística pareada com mecanismo identificado;
3. Epidemiologia das doenças crônicas, estruturada em torno do conceito de fator de risco probabilístico;
4. Propostas contemporâneas de pensar causa em múltiplos níveis (gene, indivíduo, comunidade, contexto histórico).
...
![Capa do artigo de Kenneth Rothman (1976).](images/Kenneth-rothman.png){.fig-right #fig-rothman-paper}
